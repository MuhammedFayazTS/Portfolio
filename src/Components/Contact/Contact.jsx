        ...
        <>
            <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
                <motion.div className="address" variants={variants}>
                    <motion.h2 variants={variants}>Lets Connect,</motion.h2>
                    <dl>
                        <motion.dr variants={variants}>
                            <dt>Mail</dt>
                            <dd>muhammed@1123</dd>
                        </motion.dr>
                        <motion.dr variants={variants}>
                ...
                <div className="contact-form">
                    <motion.div className="svgIcon" initial={{ opacity: 1,zIndex:3 }} whileInView={{ opacity: 0,zIndex:1 }} transition={{ delay: 3, duration: 1 }}>
